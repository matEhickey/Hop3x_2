	...
	<script src="../../js/menuFichier.js"></script>
		...
		<div class="row hop3xBox">
			...
			<ol class="list-inline">
				...
				<li><button class="btn btn-primary" onclick=<?php echo  "  \"execute(".$session.")\"  "    ?>>Executer</button></li>
			...
			<div class="col-md-10">
				...
				<!-- editeur -->			
					 ...
					 <!-- Ici viendra le code -->
						  ...
						  <div style="padding-top: 15px;">Coloration 
						  	<button onclick="setEditorLanguage(0)">C</button>
						  	<button onclick="setEditorLanguage(1)">Ruby</button>
						  	<button onclick="setEditorLanguage(2)">Java</button>
						  	<button onclick="setEditorLanguage(3)">Python</button>
						  </div>
					</div>
